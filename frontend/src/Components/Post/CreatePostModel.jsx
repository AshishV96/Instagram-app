        ...
        <ModalContent>
          ...
          <ModalBody>
            <div className='h-[70vh] justify-between pb-5 flex'>
              <div className='w-[50%]'>
                {!file && <div className='drag-drop h-full' onDrop={handleDrop} onDragOver={handleDragOver} onDragLeave={handleDragLeave}>
                  <div>
              ...
              <div className='w-[50%]'>
                ...
                <div className='flex items-center px-2'>
                  <img className='w-7 h-7 rounded-full' src="https://cdn.pixabay.com/photo/2023/05/12/08/31/bird-7987948__340.jpg" alt="" />
